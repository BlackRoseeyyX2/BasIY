...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "BasIY is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Bas [ IY FIX LOOK LIKE ADMIN +70%] v" .. currentVersion
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'to [player]', DESC = 'Go to a player'}
...
addcmd('to',{'to'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
